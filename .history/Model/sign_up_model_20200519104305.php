<?php
  ...
  function user_input_validate($mail, $password, $name, $pdo) {
    if ($mail == ""){
    ...
    }else if(!preg_match("/\A[a-z\d]{8,100}+\z/i")) {
      $_SESSION["error"]["password_check"] = "パスワードは半角英数記号のみ使用して、8文字以上で入力してください。";
    }else if($name == "") {
